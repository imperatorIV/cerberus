...
class Decoder(nn.Module):
    ...
    def forward(self, img_features, captions):
        ...
        for t in range(max_timespan):
            ...
            if self.use_tf and self.training:
                ...
                print("gated_context shape:", gated_context.shape)
    ...
    def caption(self, img_features, beam_size):
        ...
        while True:
            ...
            sentences = torch.cat((sentences[prev_word_idxs.long()], next_word_idxs.unsqueeze(1).long()), dim=1)

            #alphas = torch.cat((alphas[prev_word_idxs], alpha[prev_word_idxs].unsqueeze(1)), dim=1)
            alphas = torch.cat((alphas[prev_word_idxs.long()], alpha[prev_word_idxs.long()].unsqueeze(1)), dim=1)
            ...
            h = h[prev_word_idxs[incomplete].long()]

            #h = h[prev_word_idxs[incomplete]]
            c = c[prev_word_idxs[incomplete].long()]
            #c = c[prev_word_idxs[incomplete]]
            img_features = img_features[prev_word_idxs[incomplete].long()]
